            ...
            <div class="u-layout-row" style="">
              ...
              <div class="u-align-left u-container-style u-layout-cell u-right-cell u-size-47 u-size-xs-60 u-white u-layout-cell-2">
                <div class="u-container-layout u-container-layout-2">
                  ...
                  <p class="u-text u-text-2"> <span style="font-weight: 700;">Price</span>&nbsp;:${cartline.product.prodPrice}</p>
                  <p class="u-text u-text-2"> <span style="font-weight: 700;">count</span>&nbsp;:${cartline.productCount}</p>
                  <p class="u-text u-text-2"> <span style="font-weight: 700;">Total</span>&nbsp;:${cartline.total}</p>
